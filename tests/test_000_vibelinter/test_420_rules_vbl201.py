...
def create_rule_wrapper( code: str, filename: str = 'test.py' ):
    ''' Creates LibCST wrapper with metadata for testing rules.
        ...
        Args:
            ...
            filename: Filename to use for the module
            
        Returns:
            Tuple of (wrapper, source_lines) needed for rule instantiation
    '''
...
def run_vbl201( 
    ...
    ''' Runs VBL201 rule on code snippet and returns violations.
        ...
        Args:
            ...
            filename: Filename to use (affects hub module detection)
            hub_patterns: Optional custom hub patterns tuple
            
        Returns:
            Tuple of violations generated by the rule
    '''
